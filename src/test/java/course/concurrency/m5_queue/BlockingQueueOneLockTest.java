...
class BlockingQueueOneLockTest {

    private final static int cores = Runtime.getRuntime().availableProcessors();

    private static final Logger log = Logger.getLogger(BlockingQueueOneLockTest.class.getName());

    @Test
    void addOneItem_isOk() throws InterruptedException {
        BlockingQueueOneLock<Object> queue = new BlockingQueueOneLock<>(5);
    ...
    void addTwoManyItems_blocksQueue() throws InterruptedException {
        ...
        BlockingQueueOneLock<Object> queue = new BlockingQueueOneLock<>(maxSize);
        final Object[] values = getValues(size);
    ...
    void severalWriteSeveralRead_isOk(final int writersNumber, final int readersNumber) {
        ...
        final BlockingQueueOneLock<Object> queue = new BlockingQueueOneLock<>(maxSize);
        final Object[] values = getValues(size);
